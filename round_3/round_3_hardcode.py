    ...
    def run(self, state: TradingState):
        ...
        for product in state.order_depths:
            ...
            if product == "RAINFOREST_RESIN":
                ...
                acceptable_buy_price = 9495
                acceptable_sell_price = 9505

            elif product == "VOLCANIC_ROCK_VOUCHER_9750":
                acceptable_buy_price = 9745
                acceptable_sell_price = 9755

            elif product == "VOLCANIC_ROCK_VOUCHER_10000":
                acceptable_buy_price = 9995
                acceptable_sell_price = 10005

            elif product == "VOLCANIC_ROCK_VOUCHER_10250":
                acceptable_buy_price = 10245
                acceptable_sell_price = 10255

            elif product == "VOLCANIC_ROCK_VOUCHER_10500":
                acceptable_buy_price = 10495
                acceptable_sell_price = 10505
