...
class Trader:
    def run(self, state: TradingState):
        ...
        products = initialize_product_information(PRODUCT_NAMES, sell_order_history, buy_order_history, current_positions)
        ...
        for product in state.order_depths:
            ...
            # Skip the first iteration of trading, and only trade RAINFOREST_RESIN
            if state.traderData == "" or product != "RAINFOREST_RESIN":
